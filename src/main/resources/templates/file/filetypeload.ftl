    ...
    <div class="box-body no-padding">
        ...
        <div style="padding: 5px;">
            ...
            <div class="btn-group">
                <#if isload??>
                    <#if istrash??>
                        <a onclick="{return confirm('文件将无法复原，确定删除吗？');};" class="btn btn-sm btn-default loaddelete"
                           title="删除">
                    ...
                    <#else>
                        <a onclick="{return confirm('文件将放入回收站，确定删除吗？');};" class="btn btn-sm btn-default loadtrash"
                           title="删除">
                            <span class="iconfont icon-lajitong"></span>
                        </a>
                    </#if>
