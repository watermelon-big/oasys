        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input class="form-control" id="starTime" name="startTime"
                           value="<#if plan??>${plan.startTime}</#if>"/>
                </div>
                <div class="col-md-6 form-group">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <textarea class="form-control text" placeholder="至少20个字"
                              name="planContent"><#if plan??>${plan.planContent}</#if></textarea>
                </div>
                <div class="col-md-6 form-group">
                    <label class="control-label">总结</label>
                    <textarea class="form-control text" placeholder="至少20个字"
                              name="planSummary"><#if plan??>${plan.planSummary}</#if></textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <textarea disabled="disabled" class="form-control text"
                              name="planComment"><#if plan??>${(plan.planComment)!''}</#if></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 form-group">
