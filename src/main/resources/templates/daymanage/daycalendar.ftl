                            ...
                            <div class="box-body">
                                <div style="border-bottom: 1px solid #f4f4f4;">
                                    ...
                                    <h5 style="color: #999;font-size: 13px;">
                                        <span>发布：<span class="rcusername">aaa茨</span>   类型：<span
                                                    class="rctype">日程提醒</span></span>
                                        <span style="float:right;"><span
                                                    class="rcstarttime">2017-10-20 20:44</span> 至 <span
                                                    class="rcendtime">2017-10-20 21:44</span></span>
                                    </h5>
                                </div>
