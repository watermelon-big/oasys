                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <textarea rows="5" cols="20" class="form-control"
                                          name="describe"
                                          style="margin: 0px -0.5px 0px 0px; height: 114px; width: 522px;">${(rc.describe)!''}</textarea>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <#if rc??>
                                    <#if rc.isRemind>
                                        <span class="labels"><label><input name="isRemind" type="checkbox"
                                                                           checked/><i>✓</i></label></span>
                                    <#else>
                                        <span class="labels"><label><input name="isRemind"
