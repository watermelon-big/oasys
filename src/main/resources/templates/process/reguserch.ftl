        ...
        <div class="bgc-w box">
            ...
            <div class="box-header">
                <table class="bo table ">
                    ...
                    <tr class="top">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">建议及理解</label></div>
                        </td>
                    </tr>
                            ...
                            <div class="out" style="height:501px;">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.experience)!''}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.understand)!''}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.pullulate)!''}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.deficiency)!''}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.dobetter)!''}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:130px;text-align:center;background-color:#6d9eeb;">
                                        ...
                                        <td colspan="13" style="border-bottom: 1px solid #ddd;"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.advice)!''}</p></td>
                                    </tr>
                                    <tr>
