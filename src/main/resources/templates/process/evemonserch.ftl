                ...
                <table class="bo table ">
                    ...
                    <tr class="top ss">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">差旅信息</label></div>
                        </td>
                    </tr>
                    ...
                    <tr class="rile two">
                        ...
                        <td colspan="4">
                            <div class="bottom">${(map.tianshu)!''}</div>
                        </td>
                    </tr>
                    ...
                    <tr class="rile">
                        ...
                        <td style="width:140px;">
                            <div class="bottom">${(emoney.name)!''}</div>
                        </td>
                        <td class="css" style="width:30px;"></td>
                    ...
                    <tr class="top">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">差旅交通明细</label></div>
                        </td>
                    </tr>
                    <tr class="rile">
                        <td colspan="14">
                    ...
                    <tr class="top">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">差旅住宿明细</label></div>
                        </td>
                    </tr>
                    <tr class="rile">
                        <td colspan="14">
                            ...
                            <div class="out">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(allmoney)!''}</p></td>
                                    </tr>
                            ...
                            <div class="out">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(emoney.managerAdvice)!''}</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(emoney.financialAdvice)!''}</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
