<!-- 模态框（Modal） -->
<div class="modal fade" id="typenameModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
...
<!-- 模态框（Modal） -->
<div class="modal fade" id="changetypenameModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <p style="display: inline-block;">将联系人
                    <a href="javascript:void(0);" id="thischangetype"
                       ...
                       thiscompany="" style="color:#337ab7;line-height: 40px;">
                        <img class="img-circle" id="thischangetypeimg" src="images/touxiang/timg.jpg" alt="联系人"
