...
<th scope="col">票数</th>
    ...
    <a style="width:72px;marign-right:10px;display:inline-block;" class="votethis" href="javascript:void(0);"
       disabled="disabled" discussId="${discuss.discussId}" titleId="${voteTitle.titleId}">
    ...
    投票人员：
        ...
        <img src="/image/${(user.user.imgPath)!'timg.jpg'}" title="${user.user.userName}" alt="${user.user.userName}" class="small-img"/></a>
        </#list>
