...
set produce_time=sysdate();

update aoa_director_users
set sharetime=sysdate();
...
set notice_time=sysdate();
update aoa_notice_list
set modify_time=sysdate();


update aoa_reply_list
set replay_time=sysdate();

update aoa_user_log
set log_time=sysdate();
